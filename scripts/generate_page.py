...
def create_sample_brief() -> Dict[str, Any]:
    ...
    """
    # ⚠️ 샘플(데모)용 i-Beaute 브리프.
    #   price / urgency 값은 PLACEHOLDER 입니다 — Fresha 실제 가격·프로모로 교체 후 사용.
    #   포르티아에게 보여줄 땐 가짜 후기/수치를 넣지 말고 "sample concept"으로 명시할 것.
    return {
        "product_name": "Sofwave Skin Tightening",
        "one_liner": "Non-invasive ultrasound lifting that visibly tightens skin in one session — zero downtime.",
        "target_audience": "Sydney women 35+ noticing early sagging on the jawline, brows and neck who want a lift without surgery",
        "main_problem": "Creams and facials stop working once skin laxity sets in, but surgery feels too drastic and the downtime is impossible to fit around work and family.",
        "key_benefit": "Targeted ultrasound stimulates fresh collagen deep in the dermis for a natural lift and firmer skin — results keep improving over ~3 months, and you walk out the same day.",
        "price": {
            "original": "CONFIRM_ON_FRESHA",   # e.g. "$1,890"  ← 실제값으로 교체
            "discounted": "CONFIRM_ON_FRESHA",  # e.g. "$1,590"
            "period": "per session"
        },
        "urgency": {
            "type": "offer",
            "value": "PLACEHOLDER_PROMO",        # e.g. "This month only"  ← 실제 프로모로 교체
            "bonus": "Complimentary skin consultation included"
        },
        "booking_url": "https://www.fresha.com/book-now/i-beaute-skin-body-kx5nin73/all-offer?pId=22008",
        "brand": "I-Beaute Skin + Body",
        "location": "The Gallery, Suite 16, 445 Victoria Ave, Chatswood NSW 2067",
        "style_preset": "minimal",
        "brand_colors": {
            "primary": "#7C9885",    # sage green (i-Beaute)
            "secondary": "#C9D6CC",  # pale sage
            "accent": "#B08D57"      # soft warm gold
        }
    }
